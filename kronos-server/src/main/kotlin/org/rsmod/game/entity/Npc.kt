...
import org.rsmod.util.coords

public class Npc
@JvmOverloads
constructor(
	override val kronos: NPC,

	public val type: UnpackedNpcType,
	override val avatar: NpcAvatar = NpcAvatar(kronos, type.size),
) : PathingEntity() {
	public constructor(kronos: NPC, type: UnpackedNpcType, coords: CoordGrid) : this(kronos, type) {
		this.coords = coords
	...
	fun doInit() {
		this.lastProcessedZone = ZoneKey.from(kronos.coords)
		RsmodGlobal.npcRegistry.zoneAdd(this)
	}
