...
public sealed class PathingEntityAvatar(
	public val kronos: Entity,

    public val size: Int = kronos.size,
) {
	public var coords: CoordGrid/*CoordGrid.ZERO*/
		get() = kronos.coords
		set(value) {
			kronos.position.set(value.x, value.z, value.level)
		}

	/**
	 * The previous coordinates of this avatar.
	 *
	 * This is used to determine the previous tile the avatar was on before the last movement.
	 */
