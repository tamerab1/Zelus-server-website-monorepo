...
////        }
//
//        if (message.startsWith("::convertrs")) {
//            try {
//                int usd = Integer.parseInt(commandArg);
//                int rs3 = (int) Math.ceil(usd / 0.04);
//                EmbedBuilder eb = new EmbedBuilder();
//                eb.setTitle("USD Conversion");
//                eb.setColor(new Color(0xB00D03));
//                eb.addField("Converted:", "$" + usd + " to RS3: " + rs3 + "M", false);
//                eb.setFooter("To check USD to OSRS rates use: ::convertos");
//                e.getChannel().sendMessage(eb.build()).queue();
//            } catch (NumberFormatException ex) {
//                e.getChannel().sendMessage("Invalid number input! \n" +
//                        "Ex: $25 -> `::convertrs 25`").queue();
//            }
//        }
//        if (message.startsWith("::convertos")) {
//            try {
//                int usd = Integer.parseInt(commandArg);
...
//                eb.setFooter("To check USD to RS3 rates use: ::convertrs");
//                e.getChannel().sendMessage(eb.build()).queue();
//            } catch (NumberFormatException ex) {
//                e.getChannel().sendMessage("Invalid number input! \n" +
//                        "Ex: $25 -> `::convertos 25`").queue();
//            }
//        }
//
