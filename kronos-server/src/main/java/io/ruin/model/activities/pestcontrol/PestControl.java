...
public class PestControl {
	...
	private static void displayScoreBoard(Player player) {
		...
		player.openInterface(ToplevelComponent.MAINMODAL, PEST_CONTROL_SCOREBOARD);
	}
	...
	private static void displayRewardsShop(Player player) {
		...
		player.openInterface(ToplevelComponent.MAINMODAL, PEST_CONTROL_REWARDS);
		player.getPacketSender().sendIfEvents(PEST_CONTROL_REWARDS, 5, 0, 2, 1);
	}
