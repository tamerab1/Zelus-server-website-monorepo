...
//    {"id": 3131, "x": 2921, "y": 5327, "walkRange": 3, "z": 2}, // Zakl'n Gritch
	...
	public boolean usedMelee = false;
	public boolean bodyGuardsHitPlayer = false;
	...
	public boolean attack() {
		...
		if (withinDistance(1)) {
			usedMelee = true;
			if (target.player != null && target.player.getPrayer().isActive(Prayer.PROTECT_FROM_MELEE) && Random.rollDie(20, 2)) {
				pierceAttack();
				shout();
			} else {
				basicAttack();
