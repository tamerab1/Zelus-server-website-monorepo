...
public class Herblore {
	...
	enum Potions {
		...
		public static final Potions[] VALUES = values();
	}
	...
	enum Herbs {
		...
		public static final Herbs[] VALUES = values();
	}
	...
	public static void register() {
		...
		for (Herbs herb : Herbs.VALUES)
			ItemAction.registerInventory(herb.grimyId, "clean", (player, item) -> {
				...
				player.sendFilteredMessage("You clean the " + ObjType.get(herb.cleanId).name + ".");
			});
