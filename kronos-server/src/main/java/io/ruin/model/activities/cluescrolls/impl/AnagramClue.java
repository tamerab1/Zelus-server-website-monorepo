...
public class AnagramClue extends Clue {
	...
	public static void register() {
		register("Ranael", "An Earl", ClueType.BEGINNER);
		register("Apothecary", "Carpet Ahoy", ClueType.BEGINNER);
		register("Sedridor", "Disorder", ClueType.BEGINNER);
		register("Doric", "I Cord", ClueType.BEGINNER);
		register("Brian", "In Bar", ClueType.BEGINNER);
		register("Veronica", "Rain Cove", ClueType.BEGINNER);
		register("Gertrude", "Rug Deter", ClueType.BEGINNER);
		register("Hairdresser", "Sir Share Red", ClueType.BEGINNER);
		register("Fortunato", "Taunt Roof", ClueType.BEGINNER);
		...
		register("Brundt the Chieftain", "Dt Run B", ClueType.HARD);
