...
public enum GodwarsAltars {
	...
	BANDOS(26366, new Position(2860, 5354, 2)),
	ZAMORAK(26363, new Position(2925, 5335, 2)),
	SARADOMIN(26364, new Position(2910, 5265, 0)),
	ARMADYL(26365, new Position(2839, 5293, 2));
