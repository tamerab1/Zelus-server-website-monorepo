...
public class Vector<E>
	 ...
	 */
	@SuppressWarnings("unchecked")
	public synchronized <T> T @NotNull [] toArray(T[] a) {
	 ...
	 */
	public synchronized @NotNull ListIterator<E> listIterator(int index) {
		if (index < 0 || index > elementCount)
	 ...
	 */
	public synchronized @NotNull ListIterator<E> listIterator() {
	 ...
	 */
	@Override
	public synchronized void replaceAll(@NotNull UnaryOperator<E> operator) {
