...
public class HandHolds {
	...
	public static void register() {
		 ...
		 * Entrance/exit
		 */
		ObjectAction.register(26721, 1, (player, obj) -> player.getMovement().teleport(1588, 9899, 0));
		ObjectAction.register(26720, 1, (player, obj) -> player.getMovement().teleport(1588, 9900, 0));
