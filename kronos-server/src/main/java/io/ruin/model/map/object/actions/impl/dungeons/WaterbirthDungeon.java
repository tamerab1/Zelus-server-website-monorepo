...
public class WaterbirthDungeon {
	public static void register() {
		...
		ObjectAction.register(3831, 4, peekAction);
		ObjectAction.register(30169, 1, (player, obj) -> {
			player.getInstanceTokenInterface().selectedBoss = InstanceMaps.DKS;
		...
		ObjectAction.register(30170, 1, (player, obj) -> {
			player.step(0, player.getAbsY() > obj.y ? -2 : 2, StepType.WALK);
		});
