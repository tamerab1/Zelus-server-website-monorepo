...
public class LoyaltyTitle {
	...
	public enum Category {
		GENERAL, PVM, PVP, MASTERY, SKILLING
	}
	...
	private LoyaltyTitle(int id, Category category, boolean prefix, String text, String requirement, int cost) {
		this.id = id;
	...
	public String preview(String playerName) {
		return prefix ? (text + playerName) : (playerName + text);
	}
	...
	private static void p(int id, Category cat, String text, String req, int cost) {
		REGISTRY.add(new LoyaltyTitle(id, cat, true, text, req, cost));
	}

	private static void s(int id, Category cat, String text, String req, int cost) {
		REGISTRY.add(new LoyaltyTitle(id, cat, false, text, req, cost));
	}
	...
	static {
		s(30001, Category.GENERAL, "<col=C86402> the Fallen</col>", PURCHASE, 50000000);
		p(30002, Category.GENERAL, "<col=C86402>Lionheart </col>", PURCHASE, 50000000);
		p(30003, Category.GENERAL, "<col=C86402>Master </col>", PURCHASE, 50000000);
		s(30004, Category.GENERAL, "<col=C86402> the Undefeated</col>", PURCHASE, 250000000);
		...
		p(30010, Category.GENERAL, "<col=C86402>King </col>", PURCHASE, 50000000);
		...
		p(30018, Category.GENERAL, "<col=C86402>Emperor </col>", PURCHASE, 50000000);
		...
		p(30025, Category.GENERAL, "<col=C86402>Crusader </col>", PURCHASE, 25000000);
		...
		p(30029, Category.GENERAL, "<col=C86402>Count </col>", PURCHASE, 50000000);
		...
		s(30035, Category.GENERAL, "<col=C86402> Junior</col>", PURCHASE, 25000000);
		...
		p(30041, Category.GENERAL, "<col=C86402>Duchess </col>", PURCHASE, 50000000);
		p(30042, Category.GENERAL, "<col=C86402>Wunderkind </col>", PURCHASE, 250000000);
		...
		s(30051, Category.GENERAL, "<col=C86400> the Adorable</col>", PURCHASE, 25000000);
		p(30052, Category.GENERAL, "<col=369EDE>Clueless </col>", "Complete 250 Clue Scrolls", 50000000);
		p(30053, Category.GENERAL, "<col=C86402>Grumpy </col>", PURCHASE, 25000000);
		p(30054, Category.PVM, "<col=e80404>Godslayer </col>", "Complete all God War boss collection logs", 100000000);
		p(30055, Category.GENERAL, "<col=C86400>Archon </col>", PURCHASE, 100000000);
		...
		p(30061, Category.GENERAL, "<col=C86402>Duderino </col>", PURCHASE, 50000000);
		...
		p(30065, Category.GENERAL, "<col=C86402>Overlord </col>", PURCHASE, 100000000);
		...
		s(30073, Category.GENERAL, "<col=C86402> the Handsome</col>", PURCHASE, 50000000);
		...
		p(30079, Category.GENERAL, "<col=C86402>The </col>", PURCHASE, 50000000);
		...
		s(30082, Category.GENERAL, "<col=C86402> the Strange</col>", PURCHASE, 100000000);
		...
		p(30095, Category.GENERAL, "<col=C86402>Hellraiser </col>", PURCHASE, 50000000);
		...
		p(30098, Category.GENERAL, "<col=C86402>Flyboy </col>", PURCHASE, 50000000);
		...
		p(30103, Category.GENERAL, "<col=C86402>Baron </col>", PURCHASE, 25000000);
		...
		p(30116, Category.GENERAL, "<col=C86400>Athlete </col>", PURCHASE, 25000000);
		p(30117, Category.PVM, "<col=06A010>Moss Master </col>", "Complete Bryophyta's Collection Log", 50000000);
		p(30118, Category.GENERAL, "<col=C86402>Bandito </col>", PURCHASE, 50000000);
		p(30119, Category.GENERAL, "<col=C86401>Cheerful </col>", PURCHASE, 10000000);
		...
		s(30127, Category.GENERAL, "<col=C86402> the Intimidating</col>", PURCHASE, 50000000);
		...
		s(30135, Category.GENERAL, "<col=C86402> the Divine</col>", PURCHASE, 50000000);
		...
		s(30151, Category.GENERAL, "<col=C86402> the Mysterious</col>", PURCHASE, 50000000);
		...
		p(30156, Category.GENERAL, "<col=C86402>Desperado </col>", PURCHASE, 25000000);
		...
		p(30160, Category.GENERAL, "<col=C86402>Bigwig </col>", PURCHASE, 50000000);
		...
		s(30170, Category.GENERAL, "<col=C86402> the Hot</col>", PURCHASE, 50000000);
