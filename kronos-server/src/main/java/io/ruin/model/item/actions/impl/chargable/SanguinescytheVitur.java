...
public class SanguinescytheVitur {

	public static final int SCYTHE = 25739;
	public static final int UNCHARGED_SYCTHE = 25741;
	...
	public static void register() {
		ItemItemAction.register(UNCHARGED_SYCTHE, BLOOD_RUNE, SanguinescytheVitur::charge);
		ItemItemAction.register(SCYTHE, BLOOD_RUNE, SanguinescytheVitur::charge);
		ItemAction.registerInventory(SCYTHE, "check", SanguinescytheVitur::check);
		ItemAction.registerEquipment(SCYTHE, "check", SanguinescytheVitur::check);
		ItemAction.registerInventory(SCYTHE, "uncharge", SanguinescytheVitur::uncharge);
