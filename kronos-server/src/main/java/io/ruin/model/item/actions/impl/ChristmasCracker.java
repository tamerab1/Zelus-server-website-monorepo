	...
	public static void register() {
		ItemPlayerAction.register(962, (player, item, other) -> {
			...
			player.startEvent(event -> {
				...
				Broadcast.GLOBAL.sendNews(Icon.CHRISTMAS_TREE, "<shad=383838><col=dfe1e6>[Christmas Cracker]</col></shad>", "<col=f0e330><shad=383838> " + player.getName() + " just received " + prize.getDef().descriptiveName + " from their pull!");
