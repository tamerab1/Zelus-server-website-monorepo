...
public enum ItemUpgrading {
	...
	BLACK_MASK(8901, 11784, 1500, 10000000),
	...
	SALVE_AMULET_EI(12017, 12018, 7500, 5000000);
	...
	ItemUpgrading(int regularId, int upgradeId, int bmUpgradeCost, int coinUpgradeCost) {
		...
		ObjType regularDef = ObjType.get(regularId);
		ObjType upgradeDef = ObjType.get(upgradeId);
