...
public class VoteMysteryBox {
	...
	public static void register() {
        ...
        /*InterfaceHandler.register(VIEW_REWARDS_WIDGET, h -> {
            h.actions[96] = (SimpleAction) MysteryBox::openRewards;
            h.actions[100] = (SimpleAction) SuperMysteryBox::openRewards;
            h.actions[412] = (SimpleAction) SummerMysteryBox::openRewards;
            h.actions[416] = (SimpleAction) PVPArmourMysteryBox::openRewards;
            h.actions[420] = (SimpleAction) CrystalChestBox::openRewards;
            h.actions[424] = (SimpleAction) BrimstoneChestLoot::openRewards;
        });*/
	}

	public static void updateRewards(Player player, LootTable rewardsTable) {
	...
	private static void updateReward(Player player, int index, LootItem offer) {
		...
		player.getPacketSender().sendString(VIEW_REWARDS_WIDGET, ItemNameId, ObjType.get(offer.id).name);
