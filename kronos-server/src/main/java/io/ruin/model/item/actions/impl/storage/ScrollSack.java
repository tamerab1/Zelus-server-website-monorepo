...
public class ScrollSack extends ItemContainer {
	...
	public static void register() {
		...
		ItemItemAction.register(CLOSED_BAG, (player, ignored, itemUsed) -> {
		...
		ItemAction.registerInventory(CLOSED_BAG, 1, (player, ignored) -> {
		...
		ItemAction.registerInventory(CLOSED_BAG, "check", (player, ignored) -> player.getScrollSack().openCheck());
		ItemAction.registerInventory(CLOSED_BAG, "deposit", (player, ignored) -> player.getScrollSack().openDeposit());
