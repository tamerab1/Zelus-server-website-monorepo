...
public class Godsword {
	...
	private static final int ANCIENT_HILT = 26370;
	...
	private static final int ANCIENT_GODSWORD = 26233;
	...
	public static void register() {
		...
		ItemItemAction.register(BLADE, ANCIENT_HILT, (player, primary, secondary) -> combine(player, primary, secondary, ANCIENT_GODSWORD));
		...
		ItemAction.registerInventory(ANCIENT_GODSWORD, "dismantle", (player, item) -> dismantle(player, item, ANCIENT_HILT, BLADE));
