...
public class HolyscytheVitur {
	...
	public static void register() {
		ItemItemAction.register(UNCHARGED_SYCTHE, BLOOD_RUNE, HolyscytheVitur::charge);
		ItemItemAction.register(SCYTHE, BLOOD_RUNE, HolyscytheVitur::charge);
		ItemAction.registerInventory(SCYTHE, "check", HolyscytheVitur::check);
		ItemAction.registerEquipment(SCYTHE, "check", HolyscytheVitur::check);
		ItemAction.registerInventory(SCYTHE, "uncharge", HolyscytheVitur::uncharge);
