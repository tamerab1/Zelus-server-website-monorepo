...
public class WildernessDeadmanKey {
	...
	private static Item[] REWARDS = {
		...
		new Item(12696, 50),      // Super combat potion(4)
		new Item(13442, 50),      // Anglerfish
		new Item(3145, 50),      // Cooked Karambwan
	};
	...
	private static void handleLoot(Player player) {
		...
		player.sendFilteredMessage(Color.BLUE.wrap("You have received " + ObjType.get(loot.getId()).name + " from the Deadman chest!"));
	}
