...
public class PrayerScroll {
	...
	public static void register() {
		ItemAction.registerInventory(RIGOUR_SCROLL, "read", (player, item) -> read(player, item, VarPlayerRepository.RIGOUR_UNLOCK, "Rigour"));
		ItemAction.registerInventory(AUGURY_SCROLL, "read", (player, item) -> read(player, item, VarPlayerRepository.AUGURY_UNLOCK, "Augury"));
		ItemAction.registerInventory(PRESERVE_SCROLL, "read", (player, item) -> read(player, item, VarPlayerRepository.PRESERVE_UNLOCK, "Preserve"));
	}

	private static void read(Player player, Item item, VarPlayerRepository config, String name) {
