...
public class Arclight {
	...
	public static void register() {
		...
		ObjType.get(ARCLIGHT).addPreTargetDefendListener(Arclight::onArclightHit);
		ObjType.get(DARKLIGHT).addPreTargetDefendListener(Arclight::onDarklightHit);
	}
	...
	private static void charge(Player player, Item arclight, Item shards) {
		...
		player.dialogue(new ItemDialogue().one(ARCLIGHT, "Your Arclight now holds " + NumberUtils.formatNumber(AttributeExtensions.getCharges(arclight)) + " charges."));
