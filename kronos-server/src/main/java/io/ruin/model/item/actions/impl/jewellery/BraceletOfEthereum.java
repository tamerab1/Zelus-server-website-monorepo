...
public class BraceletOfEthereum {
	...
	public static void register() {
		...
		ObjType.get(UNCHARGED).sigmundBuyPrice = 500;
		...
		ObjType.get(CHARGED).breakId = UNCHARGED;
	}
	...
	private static void uncharge(Player player, Item bracelet) {
		player.dialogue(new YesNoDialogue("Are you sure you want to uncharge it?", "If you uncharge the bracelet, all the ether will go into your inventory.", bracelet, () -> {
