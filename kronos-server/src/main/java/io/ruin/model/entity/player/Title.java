...
public class Title {
	...
	public static final Title[] PRESET_TITLES = { //Todo @F16 Title id
		...
		prefixTitle(colorAndShadow("bb7c00", "000000", "Legend ")).setPredicate(p -> p.isSecondaryGroup(SecondaryGroup.LEGENDARY_DONATOR)).setHidden(),
		prefixTitle(colorAndShadow("0f0f0f", "000000", "Platinum ")).setPredicate(p -> p.isSecondaryGroup(SecondaryGroup.PLATINUM_DONATOR)).setHidden(),
		prefixTitle(colorAndShadow("6600FF", "000000", "The Gilded ")).setPredicate(p -> p.isSecondaryGroup(SecondaryGroup.GOLD_DONATOR)).setHidden(),
		prefixTitle(colorAndShadow("B9F2FF", "000000", "Noble ")).setPredicate(p -> p.isSecondaryGroup(SecondaryGroup.NOBLE_DONATOR)).setHidden(),
		prefixTitle(colorAndShadow("9b111e", "000000", "Elite ")).setPredicate(p -> p.isSecondaryGroup(SecondaryGroup.ELITE_DONATOR)).setHidden(),
		prefixTitle(colorAndShadow("0f52ba", "000000", "Donor ")).setPredicate(p -> p.isSecondaryGroup(SecondaryGroup.DONATOR)).setHidden(),

		prefixTitle(colorAndShadow("FA3333", "000000", "Hard ")).setPredicate(p -> p.xpMode == XpMode.HARD).setHidden(),
		prefixTitle(colorAndShadow("C2D61D", "000000", "Intermediate ")).setPredicate(p -> p.xpMode == XpMode.MEDIUM).setHidden(),
		...
		prefixTitle(colorAndShadow("d6daff", "000000", "Head Moderator ")).setPredicate(p -> p.isGroup(PlayerGroup.HEAD_MODERATOR)).setHidden(),
	};
