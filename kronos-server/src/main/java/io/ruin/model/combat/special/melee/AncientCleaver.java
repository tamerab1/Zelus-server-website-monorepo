...
// Same special as the Armadyl godsword ("The Judgement"): deal an attack that inflicts
// 37.5% more damage with double accuracy. (50%)
public class AncientCleaver implements Special {

	@Override
	public boolean accept(ObjType def, String name) {
		return name.equalsIgnoreCase("ancient cleaver");
	}
	...
	public boolean handle(Player player, Entity target, AttackStyle attackStyle, AttackType attackType, int maxDamage) {
		...
		target.hit(new Hit(player, attackStyle, attackType)
			...
			.boostDamage(0.375)
			.boostAttack(boostAttack) //100% aka double
