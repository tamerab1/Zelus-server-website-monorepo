...
public enum FishingArea {
	...
	DONATOR_ZONE(
		new Position(3815, 2819, 0),
		new Position(3816, 2819, 0),
		new Position(3817, 2819, 0)
	),
	DRAGONSTONE_ZONE(
		new Position(3698, 6928, 0),
		new Position(3699, 6928, 0),
		new Position(3700, 6928, 0),
		new Position(3707, 6929, 0),
		new Position(3708, 6929, 0),
		new Position(3709, 6929, 0)
	),
	LAVA_MAZE(
	...
	public static void register() {
		...
		DRAGONSTONE_ZONE.add(FishingSpot.KARAMBWAN_SPOT, 1);
		DRAGONSTONE_ZONE.add(FishingSpot.CAGE_HARPOON, 2);
		DRAGONSTONE_ZONE.add(FishingSpot.SMALL_NET_HARPOON, 1);
		DRAGONSTONE_ZONE.add(FishingSpot.CAGE, 1);
		DRAGONSTONE_ZONE.add(FishingSpot.BAIT, 1);
