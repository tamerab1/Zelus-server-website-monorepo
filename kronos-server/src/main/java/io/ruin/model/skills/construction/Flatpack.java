...
public enum Flatpack {
	...
	public static final Flatpack[] VALUES = values();
	...
	public static void openFlatpackCategories(Player player, int maxLevel) {
		player.openInterface(ToplevelComponent.MAINMODAL, Interface.CONSTRUCTION_FLATPACK_CREATION);
	...
	private static void openCategory(Player p, Flatpack[] set) {
		...
		p.openInterface(ToplevelComponent.MAINMODAL, Interface.CONSTRUCTION_FURNITURE_CREATION);
	}
	...
	public static void register() { // Assembling the flatpack in the hotspot
