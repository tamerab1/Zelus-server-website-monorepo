...
public class AchievementGallery {
	...
	private static void openJewelleryBox(Player player, int level) {
		...
		player.openInterface(ToplevelComponent.MAINMODAL, 590);
	...
	public static void register() {
		...
		ObjectAction.register(OCCULT_ALTAR.getBuiltObjects()[0], "venerate", (player, obj) -> switchDialogue(player, SpellBook.ANCIENT, SpellBook.LUNAR, SpellBook.MODERN));
	}
