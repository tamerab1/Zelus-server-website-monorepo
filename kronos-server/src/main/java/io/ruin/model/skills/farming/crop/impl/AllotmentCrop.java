...
public enum AllotmentCrop implements Crop {
	...
	SNAPEGRASS(22879, 231, 61, 82, 82, 7, null, new Item(COINS_995, 5000), 62, PlayerCounter.HARVESTED_SNAPEGRASS);
	...
	AllotmentCrop(int seedId, int produceId, int levelReq, double plantXP, double harvestXP, int totalStages, FlowerCrop protectionFlower,
		...
		this(seedId, produceId, levelReq, plantXP, harvestXP, totalStages, TimeUtils.getMinutesToMillis(1), protectionFlower, payment, containerIndex, counter);
	}
