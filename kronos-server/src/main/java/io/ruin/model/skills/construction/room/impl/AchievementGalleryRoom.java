...
public class AchievementGalleryRoom extends Room {
	...
	public static void register() {
		...
		for (AchievementGalleryRoom.Cape cape : AchievementGalleryRoom.Cape.values()) {
	...
	private BossDisplay bossDisplayed;
	private boolean[] storedJars = new boolean[BossDisplay.values().length];
	Cape cape = null;
