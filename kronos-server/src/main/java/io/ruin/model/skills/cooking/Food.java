...
public enum Food {
	...
	BOWL_OF_WATER(1, 0.0, 1921, 4456, -1, "a bowl of hot water", "bowl of hot water", 3, 0, 0, 0),
	...
	//Gauntlet
	PADDLEFISH(1, 10, 23872, 23874, 23873, "a paddlefish", "paddlefish", 3, 48, 48, 48),
	...
	Food(int levelRequirement, double experience, int rawID, int cookedID, int burntID, String descriptiveName,
		...
		this.rawName = ObjType.get(rawID).name;
		this.itemName = ObjType.get(cookedID).name.toLowerCase();
	...
	public static Food get(int rawID) {
