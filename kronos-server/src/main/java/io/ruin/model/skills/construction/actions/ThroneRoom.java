...
public class ThroneRoom {
	...
	public static void register() {
		...
		LocType.get(13681).clipType = 1;
		LocType.get(13681).tall = true;
		LocType.get(13682).clipType = 1;
		LocType.get(13682).tall = true;
		LocType.get(13683).clipType = 1;
		LocType.get(13683).tall = true;
