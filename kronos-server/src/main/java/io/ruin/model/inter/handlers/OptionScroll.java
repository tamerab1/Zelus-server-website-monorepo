...
public class OptionScroll {
	...
	public OptionScroll(String title, boolean allowHotkeys, boolean keepOpen, Option... options) {
		this.title = title;
	...
	public static void open(Player player, String title, boolean allowHotkeys, Option... options) {
		new OptionScroll(title, allowHotkeys, false, options).open(player);
	}
	...
	public static void openKeepOpen(Player player, String title, List<Option> options) {
		new OptionScroll(title, false, true, options.toArray(new Option[options.size()])).open(player);
	}
