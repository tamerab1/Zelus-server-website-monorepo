...
public class UsefulLinks extends QuestTabEntry {
	...
	public static String DISCORD_LINK = "https://discord.gg/eSgzHWaeqd";
	...
	public static void openUsefulLinksMenu(Player player) {
        ...
        OptionScroll.open(player, "Select a link",
                new Option(DISCORD, () -> player.openUrl(World.type.getWorldName() + " Discord", "https://discord.gg/eSgzHWaeqd")),
