...
public class ComponentID {
	...
	public static final int Krota_ZONE_GROUP_ID = 202;
	...
	public static class HeadDialogueComps {
	...
	public static class YesNoDialogueComps {
		public static final int TITLE = 6;
		public static final int CONTINUE = 0;
	}

	public static class ObjDialogueComps {
		public static final int OBJ_MODEL1 = 1;
		public static final int TEXT = 2;
		public static final int CONTINUE1 = 0;
		public static final int OBJ_MODEL2 = 3;
		public static final int CONTINUE2 = 4;
	...
	public static class MessageDialogueComps {
	...
	static class Minimap {
		...
		//TODO GET ALL IDS right for 204
