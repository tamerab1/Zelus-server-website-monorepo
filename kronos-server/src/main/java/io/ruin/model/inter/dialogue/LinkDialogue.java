...
public class LinkDialogue implements Dialogue {
	...
	public void open(Player player) {
		player.getPacketSender().sendToplevelSubInterface(Interface.LINK_DIALOGUE, Subcomponent.DIALOGUE, ToplevelComponent.CHATBOX);
	...
	public static void register() {
		InterfaceHandler.register(Interface.LINK_DIALOGUE, h -> {
			...
			h.closedAction = (player, integer) -> VarPlayerRepository.CHATBOX_INTERFACE_USE_FULL_FRAME.set(player, 0);
		});
