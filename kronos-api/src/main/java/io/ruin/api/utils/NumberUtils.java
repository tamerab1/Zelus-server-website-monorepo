...
public class NumberUtils {
	...
	public static String formatCoins(BigInteger coins) {
		if (MathUtils.gt(coins, 10000000000000L)) {
			return String.format("%.1f", MathUtils.div(coins, 10000000000000.0)) + "T";
		}

		if (MathUtils.gt(coins, 1_000_000_000)) {
			return String.format("%.1f", MathUtils.div(coins, 1_000_000_000.0)) + "B";
		}

		if (MathUtils.gt(coins, 1_000_000)) {
			return String.format("%.1f", MathUtils.div(coins, 1_000_000.0)) + "M";
		}

		if (MathUtils.gt(coins, 1_000)) {
			return String.format("%.1f", MathUtils.div(coins, 1_000.0)) + "K";
		}
