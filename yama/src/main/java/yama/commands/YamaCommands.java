...
public class YamaCommands implements CommandHandler.Hook {

	public static void register() {
		CommandHandler.hooks.register(CommandHandler.Hook.Handle.class, YamaCommands::handle);
	}
	...
	public static HooksV2.Result handle(CommandHandler.Hook.Handle ctx) {
		...
		switch (command) {
			case "yama" -> {
				teleportPlayer(player, Position.of(1439, 10074, 0));
