 ...
 * @since 2025-07-30
 */
public class MeleeAttack extends StandardAttack implements Attack {
	...
	public void invoke(Player target, NPCCombat mokhaiotl) {
		if (mokhaiotl != null) {
			...
			fireProjectile(target, AttackStyle.CRUSH, PROJECTILE, boss.getNpc());
			return;
		}

		fireProjectile(target, AttackStyle.CRUSH, PROJECTILE, target.getPosition().copy().translate(10, 0));
	}
}
