...
import io.ruin.kotlin.content.event.GameEvent
...
fun whenObjClick(id: Int, x: Int, y: Int, height: Int, option: String, action: PlayerObjectEvent) =
	ObjectAction.register(id, x, y, height, option, action)
...
fun whenRegionExit(regionId: Int, action: (Player, Boolean) -> Unit) =
	MapListener.registerRegion(regionId).onExit(action)
