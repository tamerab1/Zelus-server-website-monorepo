...
import io.ruin.kotlin.content.event.GameEventProcessor.plusAssign
 ...
 * @author Heaven
 */
class GameEvent(val ctx: Any?, val fn: suspend GameEvent.() -> Unit) :
	CoroutineScope by CoroutineScope(Server.worker.executor.asCoroutineDispatcher()) {
