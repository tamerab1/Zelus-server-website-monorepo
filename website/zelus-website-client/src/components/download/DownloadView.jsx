...
const PLATFORMS = [
  {
    ...
    note:      'Recommended. Installs once, auto-updates itself.',
    available: true,
  },
  {
    id:        'jar',
    label:     'Client.jar',
    badge:     'Windows • Java 21 required',
    file:      'client.jar',
    note:      'No installer. Download and double-click to play.',
    available: true,
  },
];
    ...
    <div style={{ minHeight:'100vh', paddingBottom:80 }}>
      ...
      <div style={{ maxWidth:700, margin:'0 auto', padding:'0 24px' }}>
        ...
        <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fit,minmax(180px,1fr))', gap:24 }}>
          {[
            { n:'1', title:'Download',   body:'Get the launcher, or client.jar if you already have Java.' },
            { n:'2', title:'Run it',     body:'Install the launcher, or just double-click client.jar.' },
            { n:'3', title:'Play',       body:'You\'re connected to Zelus automatically.' },
          ].map(({ n, title, body }) => (
