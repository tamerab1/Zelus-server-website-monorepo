...
public enum CollectionLogData {
	...
	CINDERMAW(CollectionLogUpdated.Categories.BOSSES, "Cindermaw",
			new Item[] { (new Item(60236)/* Teumo */), (new Item(60237)/* Orrvor quo Maten */),
					(new Item(60238)/* Lord Trobin */), (new Item(60241)/* The Monkey's Aunt */),
					(new Item(60242)/* Tempoross */), (new Item(60243)/* Strisath */), (new Item(60244)/* Starlight */),
					(new Item(60246)/* Spooky dog */), (new Item(60247)/* Spit goblin */), (new Item(60248)/* Shadow Keeper */),
					(new Item(60249)/* Slimetoes */), (new Item(60250)/* SteelWill */), (new Item(60252)/* Damo */),
					(new Item(60253)/* Sliske */), (new Item(60254)/* Light Leech */), (new Item(60255)/* ToxiSkele */),
					(new Item(22960)/* Drake's tooth */), (new Item(22957)/* Drake's claw */) },
			// completion rewards
			new Item[] {
					new Item(7478, 15),
					new Item(30461, 1),
	...
	DOOM_OF_MOKHAIOTL(CollectionLogUpdated.Categories.BOSSES, "Doom of Mokhaiotl",
		new Item[] { (new Item(31099)/* Mokhaiotl waystone */), (new Item(31109)/* Mokhaiotl cloth */),
			(new Item(31113)/* Eye of Ayak */), (new Item(31088)/* Avernic treads */) },
		// completion rewards
		new Item[] {
			new Item(30446),
			new Item(2528, 2),
